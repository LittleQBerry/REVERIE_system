...
if (args.env_num == 1):
	args.env_name = 'soccer_tech1'
	args.demo_traj_path = 'data/soccer_tech1_data.p'	
	args.K_delta = 50	
	args.sparse_val = 2.
	env_tag = 'Sparse2'
	args.delta_0 = 0.01
	...
	args.observe = 0
	if args.init_BC:
		args.model_path = 'bc_models/soccer_tech1_model.pt'
		args.delta_0 = 0.05
	eval_env = gym.make(args.env_name)


elif (args.env_num == 2):
	args.env_name = 'soccer_tech2'
	args.demo_traj_path = 'data/soccer_tech2_data.p'
	args.K_delta = 50	
	args.sparse_val = 2.
	...
	args.env_name = 'soccer_tech3'
	args.demo_traj_path = 'data/soccer_tech3_data.p'	
	args.K_delta = 50	
	args.sparse_val = 20.
	env_tag = 'Sparse20'
	args.delta_0 = 0.2
	...
	args.observe = 0
	if args.init_BC:
		args.model_path = 'bc_models/soccer_tech3_model.pt'
		args.delta_0 = 0.05
	eval_env = gym.make(args.env_name)
	...
	args.env_name = 'soccer_tech4'
	args.demo_traj_path = 'data/soccer_tech4.p'
	args.K_delta = 50	
	args.sparse_val = 20.
	...
	args.env_name = 'soccer_tech5'
	args.demo_traj_path = 'data/soccer_tech5.p'		
	args.K_delta = 50	
	args.sparse_val = 2.
	env_tag = 'Sparse2'
	args.delta_0 = 0.05
	...
	args.observe = 0
	if args.init_BC:
		args.model_path = 'bc_models/soccer_tech5.pt'
		args.delta_0 = 0.05
	eval_env = gym.make(args.env_name)
	...
	args.env_name = 'table_tech1'
	args.demo_traj_path = 'data/table_tech1_data.p'
	args.K_delta = 50	
	args.sparse_val = 2.
	env_tag = 'Censored_Sparse2'
	args.delta_0 = 0.05
	...
	args.env_name = 'table_tech2'
	args.demo_traj_path = 'data/table_tech2.p'	
	args.K_delta = 5
	args.delay_val = 1000
	env_tag = 'Dealy1000'
	args.delta_0 = 0.2
	...
	args.observe = 0
	if args.init_BC:
		args.model_path = 'bc_models/table_tech2.pt'
		args.delta_0 = 0.05
	eval_env = gym.make(args.env_name)

elif (args.env_num == 8):
	args.env_name = 'table_tech3'
	args.demo_traj_path = 'data/table_tech3_data.p'
	args.K_delta = 5
	args.delay_val = 1000
